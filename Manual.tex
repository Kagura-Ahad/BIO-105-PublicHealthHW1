...
\begin{questions}
    ...
    \begin{solution}
        ...
        \end{equation*}
        \begin{parts}
            \part For the cholesterol class with levels less than 220 mg\%, the incidence rate of coronary heart disease is given by:
            \begin{equation*}
                \text{Incidence Rate} = \frac{3}{400} \times 1000 = 7.5 \text{ cases per 1000 person-years}
            \end{equation*}
            \part For the cholesterol class with levels between 220-270 mg\%, the incidence rate of coronary heart disease is given by:
            \begin{equation*}
                \text{Incidence Rate} = \frac{12}{900} \times 1000 = 13.3 \text{ cases per 1000 person-years}
            \end{equation*}
            \part For the cholesterol class with levels greater than 270 mg\%, the incidence rate of coronary heart disease is given by:
            \begin{equation*}
                \text{Incidence Rate} = \frac{14}{700} \times 1000 = 20 \text{ cases per 1000 person-years}
            \end{equation*}
        \end{parts}
    \end{solution}
